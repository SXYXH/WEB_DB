	...
	try{
		...
		if(sk == null && search_data == null){
			...
			pstmt = conn.prepareStatement(
					"SELECT u.u_id, u.u_pw, u.u_level, u.u_name, u.u_email, u.u_phone, u.u_addr FROM tb_user AS u WHERE u."+sk+" = ?");
...
%>
					<tr>
						...
						<td><a href = "<%= request.getContextPath()%>/userdelete/user_delete_pro.jsp?send_id=<%= rs.getString("u_id")%>">삭제버튼</a></td>
					</tr>
